...
class ImportExcel implements Shortcode {
    const SHORTCODE = 'hmg_import';
    const SCRIPT_HANDLE = 'hmg_import';
    
    public function render( array $atts ): string|false {
        ob_start();

        load_template( TMT_HMG_PATH . 'Base/ImportExcel.php', true );
    ...
    public function scripts(): void {
        Vite\register_asset(
            TMT_HMG_PATH . 'dist',
            'src/pages/ImportExcel/main.jsx',
            array(
