...
class Dashboard implements Shortcode {
    ...
    public function scripts(): void {
        ...
        wp_register_style( 
            self::SCRIPT_HANDLE,
            TMT_HMG_URL . 'src/assets/dashboard.css',
            array(),
            filemtime( TMT_HMG_PATH . 'src/assets/dashboard.css' )
        );
    }
}